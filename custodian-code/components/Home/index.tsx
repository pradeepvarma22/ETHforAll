        ...
        <>
            <section className="pt-32" >
                ...
                <div className="absolute top-1/4 left-24">
                    ...
                    <h2 className="text-6xl font-semibold">Discover, collect</h2>
                    <h2 className="text-6xl font-semibold">and sell extraordinary NFTs</h2>
                    <div className="text-4xl font-bold pt-4 text-red-600">
                        <TypewriterComponent />
                    </div>
