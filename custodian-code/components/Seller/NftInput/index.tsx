                ...
                <div className="pt-16">
                    ...
                    <ul className="grid w-full gap-6 md:grid-cols-2">
                        ...
                        <li onClick={e => store.dispatch(setPayWith(IPaymentType.CRYPTO))}>
                            <input type="radio" name="paymentType" value={IPaymentType.CRYPTO} onChange={handleDummy} checked={payWith === IPaymentType.CRYPTO} className="hidden peer" />
                        ...
                        <li onClick={e => store.dispatch(setPayWith(IPaymentType.CREDIT_CARD))}>
                            <input type="radio" name="paymentType" onChange={handleDummy} value={IPaymentType.CREDIT_CARD}
